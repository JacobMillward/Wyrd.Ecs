...
public class QueryFluentBuilderTests
{
    ...
    public void Without_ExcludesTaggedEntities()
    {
        ...
        var count = 0;
        world.Query().With<Position>().With<Velocity>().Without<Dead>()
    ...
    public void Any_RequiresAtLeastOneOfTheGiven()
    {
        ...
        world.Query().With<Position>().Any<BuffA, BuffB>()
    ...
    public void Has_RequiresPresenceWithoutExposingAnAccessor()
    {
        ...
        var matchedCount = 0;
        world.Query().With<Position>().Has<BuffA>()
    ...
    {
        var world = new World();
        Entity onlyFirstGroup = world.Commands.CreateEntity();
