...
/// <summary>
/// A callback invoked once per matching archetype chunk. <typeparamref name="TAccess0"/>
/// is <see cref="Mut{T}"/> for tracked mutable access, or <see cref="Ref{T}"/> for
/// read-only access that never marks anything dirty.
/// </summary>
