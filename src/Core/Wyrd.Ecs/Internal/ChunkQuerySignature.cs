...
/// <summary>
/// The required <see cref="TypeBitSet"/> for a chunk-callback query over
...
{
    internal static readonly TypeBitSet Value = TypeBitSet.Empty.With(TAccess0.TypeIndex);
}
...
{
    internal static readonly TypeBitSet Value = TypeBitSet.Empty.With(TAccess0.TypeIndex).With(TAccess1.TypeIndex);
}
