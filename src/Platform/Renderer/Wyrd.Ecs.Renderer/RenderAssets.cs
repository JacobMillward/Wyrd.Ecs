...
/// wanting to load something declares <c>[Resource] public RenderAssets Assets { get; private
/// set; }</c> (reactive, per-tick loading) or <c>in RenderAssets assets</c> on its constructor
...
/// </summary>
public readonly record struct RenderAssets(RendererSystem Renderer) : IResource
{
