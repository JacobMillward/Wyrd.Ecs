...
public partial class QueryIterationBenchmarks
{
    private sealed class WyrdContext
    {
        ...
        public WyrdContext(int entityCount, bool fragmented)
        {
            ...
            {
                Entity e1 = World1.Commands.CreateEntity(new Position());
                Entity e2 = World2.Commands.CreateEntity(new Position(), new Velocity());
                Entity e3 = World3.Commands.CreateEntity(new Position(), new Velocity(), new Health());
                Entity e4 = World4.Commands.CreateEntity(new Position(), new Velocity(), new Health(), new BulkPayload());
                Entity e5 = World5.Commands.CreateEntity(new Position(), new Velocity(), new Health(), new BulkPayload(), new Padding1());
